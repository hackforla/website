...
const commentByDays = -1; // If there is an update within 14 days but no update within 7 days, the issue is considered outdated and the assignee needs 'To Update !' it. Set to -1 for testing purposes only
